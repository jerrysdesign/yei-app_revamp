...
type ConnectWalletActionProps = {
    visible: boolean;
    onClose: () => void;
};

const ConnectWalletAction = ({ visible, onClose }: ConnectWalletActionProps) => {
    return (
                    ...
                    <Dialog.Panel className="relative z-10 shrink-0 flex flex-col w-[37.25rem] min-h-full m-auto mr-0 -translate-x-[5%] bg-n-1 rounded-3xl md:w-full md:rounded-none md:min-h-screen-ios dark:bg-n-6">
                        <div className="relative h-64 p-8 text-center md:h-56">
                            ...
                            <div className="relative z-1w-[5.75rem] mx-auto">
                                <Image
                                    src="/images/logo-dark-vertical.svg"
                                    width={135}
                                    height={66}
                                    alt=""
                                />
                        ...
                        <div className="relative -mt-[3.25rem] px-15 pb-12 md:px-5 md:pb-8">
                            <WalletList items={walletList} />
                        </div>
                    </Dialog.Panel>
                </Transition.Child>
            </Dialog>
